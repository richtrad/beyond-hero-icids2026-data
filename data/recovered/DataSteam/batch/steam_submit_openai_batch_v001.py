...
# -*- coding: utf-8 -*-
"""
steam_submit_openai_batch_v001.py
...
Outputs:
  ...
  steam_bulk_outputs/steam_protagonist_batch_submit_info_v001.json
"""
...
INPUT_JSONL = Path("steam_bulk_outputs/steam_protagonist_batch_input_v001.jsonl")
OUT_BATCH_ID = Path("steam_bulk_outputs/steam_protagonist_batch_id_v001.txt")
OUT_INFO = Path("steam_bulk_outputs/steam_protagonist_batch_submit_info_v001.json")


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--input", default=str(INPUT_JSONL))
    parser.add_argument("--description", default="Steam protagonist identification v001")
    ...
    print("Check later with: python steam_retrieve_openai_batch_v001.py")
